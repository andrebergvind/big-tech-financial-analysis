...
The analysis began with examining which company had the highest revenues each year:
...
Therafter, the analysis went on to look for revenue growth, EPS growth, and whether earnings are improving over time.
...
The next step was to understand how efficiently companies convert revenue into profit. Primarily the analysis focused on gross and net margins. 
...
The results were fairly similar among Intel, Microsoft, and NVIDIA, increasing over the past years all falling in under 45%. 
Apple however showcases a much larger debt to equity ratio steadily increasing and falling in at 237% in 2022.
Google showed the lowest debt to equity value of approximately 5%
